...
export const KNOWN_CONFIG_GROUPS = [
  {
    name: 'com.affine.adminSettings.group.server',
    module: 'server',
    fields: ['externalUrl', 'name', 'hosts'],
  } as ConfigGroup<'server'>,
  {
    name: 'com.affine.adminSettings.group.auth',
    module: 'auth',
    fields: [
      'allowSignup',
      'allowSignupForOauth',
  ...
  {
    name: 'com.affine.adminSettings.group.mailer',
    module: 'mailer',
    fields: [
      'SMTP.name',
      'SMTP.host',
  ...
  {
    name: 'com.affine.adminSettings.group.storages',
    module: 'storages',
    fields: [
      {
        key: 'blob.storage',
  ...
  {
    name: 'com.affine.adminSettings.group.oauth',
    module: 'oauth',
...
export const UNKNOWN_CONFIG_GROUPS = ALL_CONFIGURABLE_MODULES.filter(
  ...
  name: `com.affine.adminSettings.group.${module}`, // Use key pattern for unknown groups too
  module,
